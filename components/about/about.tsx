      ...
      <div className="flex flex-col items-center gap-10">
        ...
        <div className="flex gap-4 pl-0 lg:pl-10 flex-col flex-1">
          <div className="flex gap-2 flex-col p-2">
            ...
            <p className="text-lg max-w-xl lg:max-w-sm leading-relaxed tracking-tight text-muted-foreground">
              Designer Gráfico, em 2022 participei no treinamento de Design Gráfico e Multimédia, gosto, e tem sido gratificante até agora dar vida a projectos gráficos.
            </p>
          </div>
        </div>
      </div>
